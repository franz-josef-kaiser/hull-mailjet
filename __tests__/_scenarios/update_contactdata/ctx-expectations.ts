...
import { CONCONF_SUBACCOUNT_SLUG, MJ_IDENT1_EMAIL, MJ_IDENT1_ID, HULL_USER_NAME0, HULL_USER_JOBTITLE1 } from "../../_helpers/constants";
...
const setupExpectations = (ctx: ContextMock, apiResponses: IApiResponseNocked[]) => {
    ...
    _.set(expectedAttribs, `mailjet_${CONCONF_SUBACCOUNT_SLUG.toLowerCase()}/job_title`, HULL_USER_JOBTITLE1);
