...
import { API_KEY, API_SECRET_KEY, CONCONF_SUBACCOUNT_SLUG, HULL_SEGMENT1, MJ_LIST1, HULL_USER_NAME1 } from "../../_helpers/constants";
...
const configurePayload = (): IHullUserUpdateMessage => {
    ...
    // Configure name to be updated
    _.set(basePayload, "messages[0].user.name", HULL_USER_NAME1);
