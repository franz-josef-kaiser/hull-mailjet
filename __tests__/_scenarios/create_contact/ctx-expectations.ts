...
import { CONCONF_SUBACCOUNT_SLUG, MJ_IDENT1_EMAIL, MJ_IDENT1_ID } from "../../_helpers/constants";
...
const setupExpectations = (ctx: ContextMock, apiResponses: IApiResponseNocked[]) => {
    ...
    _.set(expectedAttribs, "name", { value: "John Doe", operation: "setIfNull" });
    _.set(expectedAttribs, `mailjet_${CONCONF_SUBACCOUNT_SLUG.toLowerCase()}/name`, "John Doe");
    ...
    _.set(expectedAttribs, `mailjet_${CONCONF_SUBACCOUNT_SLUG.toLowerCase()}/list_recipients`, [{"ContactID": 1234, "ID": 1443964, "IsActive": true, "IsUnsubscribed": false, "ListID": 1115, "ListName": "Demo list", "SubscribedAt": "2019-06-25T10:52:30Z", "UnsubscribedAt": ""}]);
